        ...
        <div class="col-md-4 d-flex justify-content-center align-items-center">
          <div class="card mb-4 shadow-sm">
            ...
            <div class="d-flex justify-content-center mt-3"><img style="box-shadow: 0px 0px 8px #000000;"
                class="rounded-circle" width="50" height="50" src="<?php echo $img_perfil?>" alt=""></div>
            <div class="card-body">
          ...
          <form class="needs-validation" method="POST" action="php/publicar.php" novalidate>
            <div class="row">
              <div class="col-md mb-3">
                ...
                <input type="text" class="form-control" id="img" name="img" placeholder="" value="" required
        ...
        <div class="col-md-12">
          ...
          <div class="row mb-2">
            ...
            <div class="col-md-9 d-flex flex-column vertical-align-center justify-content-center">
              ...
              <div class="btn-group">
                <a href="#foto"><button class="btn btn-secondary"
                    onclick="editar('<?php echo $anuncios['img']?>','<?php echo utf8_encode($anuncios['descricao'])?>','<?php echo utf8_encode($anuncios['valor'])?>','<?php echo utf8_encode($anuncios['id'])?>')">Editar</button></a>
                <button class="btn btn-danger rounded ml-2" data-toggle="modal" data-target="#modalDeletar"
                  onclick="deletar('<?php echo utf8_encode($anuncios['id'])?>')">Deletar</button>
              </div>
            </div>
          </div>
          <hr>
