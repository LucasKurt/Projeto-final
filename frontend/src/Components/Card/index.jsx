...
const Card = ({ img, imgPerfil, descricao, valor, opc, doacao , id_vendedor, redirecionar }) => {
    ...
    return (
        <div className="card mb-4 shadow-sm" onClick={() => redirecionar && history.push(`/vendedor/${id_vendedor}`)} >
            <img id="imgPlaceholder" height={225} src={img === '' ? 'http://localhost:3333/uploads/anuncio/ponto-de-interrogação.jpeg' : img} alt="Imagem do anuncio" />

            <div className="d-flex justify-content-center mt-3"><img style={{ boxSahdow: '0px 0px 8px #000000' }} className="rounded-circle" width={50} height={50} src={`http://localhost:3333/uploads/perfil/${imgPerfil}`} alt="Perfil vendedor" /></div>
