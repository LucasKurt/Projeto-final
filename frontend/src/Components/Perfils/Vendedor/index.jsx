                ...
                <div className="row">
                    <div className="col-md-4 d-flex justify-content-center align-items-center">
                        <div className="card mb-4 shadow-sm">
                            ...
                            <div className="d-flex justify-content-center mt-3"><img style={{ boxShadow: '0px 0px 8px #000000' }} className="rounded-circle" width={50} height={50} src="./images/perfil_vendedor/<?php echo $img_perfil?>" alt /></div>
                            <div className="card-body">
                                <p className="card-text text-center">{/*?php echo $negocio?*/}</p>
                                <p id="descricaoAnuncio" className="card-text text-center">O que? (breve descrição)</p>
                                <p id="valorAnuncio" className="card-text text-center">Quanto? (Informe o preço)</p>
                                <p id="aceitaDoacao" className="card-text text-center">Aceita doação? (Marque a opção)</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-8">
                        ...
                        <form className="needs-validation" method="POST" action="php/publicar.php" encType="multipart/form-data" noValidate>
                            ...
                            entre o cliente e o vendedor.">
                                                <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="currentColor" className="bi bi-info-circle-fill text-primary mr-3 tooltip-test" title="Ao clicar nesse botão você aceita receber doações e consequentemente aceita também fazer um desconto a pessoa que cedeu as doações nos seus termos. A plataforma não fará mediações, a negociação será feita entre o cliente e o vendedor" viewBox="0 0 16 16">
            ...
            <div className="row mb-2">
                            ...
                            <div className="col-md-9 d-flex flex-column vertical-align-center justify-content-center">
                                ...
                                <div className="btn-group">
                                    <a href="#foto"><button className="btn btn-secondary" onclick="editar('<?php echo $anuncios['img']?>','<?php echo utf8_encode($anuncios['descricao'])?>','<?php echo utf8_encode($anuncios['valor'])?>','<?php echo utf8_encode($anuncios['id'])?>')">Editar</button></a>
                                    <button className="btn btn-danger rounded ml-2" data-toggle="modal" data-target="#modalDeletar" onclick="deletar('<?php echo utf8_encode($anuncios['id'])?>')">Deletar</button>
                                </div>
                            </div>
                        </div>
                        <hr />
