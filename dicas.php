    ...
    <main class="container">
        <div class="p-4 p-md-5 mb-4 text-white rounded bg-dark">
            <div class="col-md-6 px-0">
                ...
                <p class="lead my-3">Todas as dicas desta página serão atualizadas semanalmente, indicaremos cursos,  incentivos para que você possa garantir seus direitos sendo MEI e dicas para que você possa impulsionar o seu negócio.</p>
            </div>
        </div>
        ...
        <div class="row featurette">
            <div class="col-md-7">
                ...
                <p class="lead">Conhecer os direitos e deveres do Microempreendedor Individual e da Microempresa, identificando as diferenças entre o MEI e a ME.</p>
            ...
            <div class="col-md-5">
                <img class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500"
                    height="500"
                    src="./images/como-expandir-seu-negocio.webp" alt="Como expandir seu negócio.">
            </div>
        </div>
        ...
        <div class="row featurette">
            <div class="col-md-7 order-md-2">
                ...
                <p class="lead">Conheça os benefícios e os passo a passo de se formalizar como microempreendedor individual e quais os riscos em manter uma empresa informal.</p>
