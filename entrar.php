...
<body class="text-center">
  ...
  <form class="form-signin" method="post" action="php\confirma_login.php">
    ...
    <a class="btn btn-lg btn-primary btn-block btn-vendedor" style="text-decoration: none;" href="login.php"
      role="button">Vendedor</a>

    <a class="btn btn-lg btn-primary btn-block btn-cliente" style="text-decoration: none;" href="login-cliente.php"
